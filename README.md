...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-omw0hjq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-omw0hjq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Balwant8498/container-omw0hjq.git
cd container-omw0hjq
```
...
```
docker attach container-omw0hjq
```
